...
test("getLocator resolves locatorPath references in filters", async ({ page }) => {
	type LocatorSchemaPaths =
	...
	const locator = registry.getLocator("fictional.locatorAndOptionsWithfilter@allOptions");
...
test("getLocator resolves inline locator definitions in filters", async ({ page }) => {
	...
	const locator = registry.getLocator("fictional.locatorWithfilter@allOptions");
...
test("getLocator rejects frame locator definitions inside filters", async ({ page }) => {
	...
	expect(() => registry.getLocator("fictional.filter@hasNotText")).toThrow(
		/Frame locators cannot be used as filter locators/,
	);
});

test("getLocator resolves has/hasNot locatorPath references", async ({ page }) => {
	type LocatorSchemaPaths =
		| "body.section.heading"
	...
	const locator = registry.getLocator("fictional.filter@hasNotText");
...
test("getLocator resolves inline locator definitions for has/hasNot", async ({ page }) => {
	type LocatorSchemaPaths = "fictional.filter@hasNotText";
